...
(function($) {
     ...
     * 
     * To use this plugin, include the renderer jquery file in
     * your source:
     * 
     * > <script type="text/javascript" src="plugins/jqplot.ohlcRenderer.jquery"></script>
     * 
     * You will most likely want to use a date axis renderer
     * for the x axis also, so include the date axis render jquery file also:
     * 
     * > <script type="text/javascript" src="plugins/jqplot.dateAxisRenderer.jquery"></script>
     * 
