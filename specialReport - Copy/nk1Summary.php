...
class PDF extends FPDF
{
    function FancyTable($resultData,$endDate)
    {
        ...
        $this->Ln(70);
            ...
            $this->Cell(200, 7, 'E-Mail : sunnyvinner@hotmail.com', 0, 1, 'L');
            $this->Cell(200, 7, iconv('UTF-8', 'cp874', 'นายวิสันต์  จรลี  ๐๘๙๖๒๘๘๒๐๙'), 0, 1, 'L');
        ...
        $this->Ln(20);
        $this->Cell(200, 10, iconv('UTF-8', 'cp874', 'ลื่อชื่อ..................................ผู้ส่ง'), 0, 1, 'C');
        $this->Cell(200, 10, iconv('UTF-8', 'cp874', '(นายวิสันต์  จรลี)'), 0, 1, 'C');
        $this->Cell(200, 10, iconv('UTF-8', 'cp874', '(เจ้าพนักงานเวชสถิติ ปฏิบัติงาน)'), 0, 1, 'C');
